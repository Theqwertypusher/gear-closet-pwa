          ...
          {#each dragLists as list (list.id)}
            ...
            <div class="relative">
              <button
                ...
                class="w-full text-left rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors active:scale-[0.99]"
              >
                <h3 class="font-semibold text-zinc-900 dark:text-zinc-100 truncate pr-10">{list.name}</h3>
